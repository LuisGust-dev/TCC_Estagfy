...
@section('title', 'Novo Usuário | Admin EstagFy')
    ...
    <div class="max-w-3xl">
        <div class="mb-6 flex items-center justify-between gap-3">
            <div>
                ...
                <p class="text-gray-600">Cadastre aluno, empresa, coordenador ou admin.</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="active" class="mt-1 w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" required>
                            <option value="1" @selected((string) old('active', '1') === '1')>Ativo</option>
                            <option value="0" @selected((string) old('active') === '0')>Inativo</option>
                        </select>
                    </div>
                </div>
