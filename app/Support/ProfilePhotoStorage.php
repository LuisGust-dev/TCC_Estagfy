...
class ProfilePhotoStorage
{
    public static function store(UploadedFile $file): string
    {
        ...
        $path = 'profiles/' . Str::uuid() . '.' . strtolower($extension);
        ...
        if (! $response->successful()) {
            throw new RuntimeException('Falha ao enviar foto de perfil para o Supabase.');
        }
    ...
    public static function publicUrl(?string $path): ?string
    {
        ...
        if (static::isSupabaseConfigured() && ! str_starts_with($path, 'profiles/')) {
